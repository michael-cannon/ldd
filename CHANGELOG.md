...
* Rename `ldd_deliveries` to `wps` for action and filter names
* Revise headers
* Revise installation instructions
* Revise readme installation
* Revise readme structure
* Revise readme.txt structure
* Revise `get_defaults` usage with filter `ldd_deliveries_settings_defaults`
* SEO tweaks
...
* Use str_getcsv
* Use LDD_DELIVERIES_PREMIUM_LINK constant